...
class ManageInquiry extends StatelessWidget {
  const ManageInquiry({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   for (String i in ManageInquiry._buttonList)
      //     OutlinedButton(
      //         onPressed: () {},
      //         child: SimpleText(i, fontSize: ManageInquiry._cFontSize)),
      // ],
                ...
                Card(
                  child: Column(
                    children: [
                      ...
                      const Divider(
                          thickness: 1.2, endIndent: 50.0, indent: 15),
                      _InquiryTile(
                          title: 'Son Goku',
            ...
            child: Row(
              ...
              children: _buttonList
                  .map((e) => OutlinedButton(
                      onPressed: () {},
                      child: SimpleText(e, fontSize: ManageInquiry._cFontSize,)))
                  .toList(),
            ),
          ),
        ],
